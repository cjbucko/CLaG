...
#		Continue from the third goal, but this time if you have enough bread and peanut butter but no jelly, print a message that tells you that you can
#                      make a peanut butter sandwich
#		Or if you have more peanut butter and bread than jelly, that you can make a certain number of peanut butter & jelly sandwiches and a
#                      certain number of peanut butter sandwiches
...
if bread >= 2 and peanut_butter >= 1 and jelly >= 1:
     print ("I am having a peanut butter and jelly sandwich for lunch today.")
else:
    print ("Looks like I don't get lunch today.")

#Goal 2
if bread/2 >= 2 and peanut_butter >= 1 and jelly >= 1:
     print ("I can make {0} sandwiches.".format(min(bread/2, jelly, peanut_butter)))
else:
     print ("Looks like I don't get lunch today.")

#Goal 3
if bread % 2 != 0 and peanut_butter % 2 >= 0 and jelly % 2 >= 0:
     print ("You can make open face sandwiches too.")  
elif bread < 1 or peanut_butter < 1 or jelly < 1:
     print ("Looks like I don't get lunch today")
else:
     print ("You get to make whole sandwiches")

#Goal 4
if jelly == 0 and peanut_butter > 1:
    print ("You can make a peanut butter sandwich.")
elif bread > jelly and peanut_butter > jelly:
    print ("you can make {0} PBJ sandwiches and {1} PB sandwich." .format(jelly, bread/2 - jelly))

#Goal 5
print ("I need the following ingredients: ")
